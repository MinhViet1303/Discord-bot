...
class Create_data(commands.Cog):
    def __init__(self, bot):
        ...
        # Hàm tạo database "main" và bảng "userlist" nếu chưa tồn tại
    async def create_main_db(self):
        ...
        try:
            ...
            if "main" not in existing_databases:
                ...
                # Tạo bảng "userlist" và các cột tương ứng
                main_cursor.execute("""
    ...
    async def create_user_db(self, user_id, user_name):
        ...
        try:
            ...
            if existing_user is None:
                ...
                main_cursor.execute('INSERT INTO user_data (db_user_id, db_user_name, db_exp, db_level, db_exp_need, db_wallet, db_bank) VALUES (%s, %s, %s, %s, %s, %s, %s)', (user_id, user_name, exp, level, exp_needed, wallet, bank))
                main_connection.commit()
    ...
    async def on_message(self, message):
        ...
        await self.create_main_db()
        await self.create_user_db(user_id, user_name)
